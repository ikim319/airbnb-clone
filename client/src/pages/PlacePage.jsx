    ...
    if (showAllPhotos) {
        return (
            <div className="absolute inset-0 bg-black text-white min-h-screen">
                <div className="bg-black py-10 p-8 grid gap-4">
                    <div>
                        <button onClick={() => setShowAllPhotos(false)} className="fixed top-2 flex gap-1 py-2 px-4 text-black rounded-3xl shadow shadow-black bg-white">
